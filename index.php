...
<body style="background-color: rgb(66,66,66);">
    ...
    <div class="container" style="margin-top: 30px; margin-bottom: 30px; border-radius: 10px; background-color: #ffffff">
        ...
        <a href="controlador_agenda.php?acao=logout" class="btn btn-danger" style="float: right">Logout</a>

        <h3> Agenda de contatos do <?= $usuario ?></h3>
        <br/>

        <!-- CADASTRO-->
        <div class="row">
            <div class="col-md-12">
                <form class="form-inline" action="controlador_agenda.php?acao=cadastrarContatos" method="post">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>            <?= $cont['email']    ?></td>
                            <td>            <?= $cont['telefone'] ?></td>
                            <td><a type="button" class="btn btn-danger" href="controlador_agenda.php?acao=exclui&id=<?= $cont['id'] ?>" >X</a></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
